...
export function OneRestaurant(){
    return (<div className={'single_restaurant'}>
                                ...
                                return(
                                    <Box className={'dish_box'} key={`${index}`}>
                                        <Box
                                            className={'dish_img'}
                                            sx={{
                                                backgroundImage: `url("/restaurant/food_city.jpg")`,
                                            }}
                                        >
                        ...
                        return(
                            <Box className={'review_box'} key={index}>
                                ...
                                <p className={'review_desc'}>
                                    Menga bu oshxona juda yoqadi. Hammaga tavsiya qilaman!!!
                                </p>
        ...
        <Container className={'member_review'}>
            <Box sx={{ textAlign: 'center' }} className={'category_title'}>Oshxona haqida</Box>
            <Stack
                display={"flex"}
                flexDirection={"row"}
                width={"90%"}
                        ...
                        return(
                            <Box display={"flex"} flexDirection={"row"} key={index}>
                                ...
                                <div className={'about_right_desc'}>
                                    ...
                                    <p>
                                        Bizning oshpazlarimiz dunyo taniydigan oshxonalarda malaka
                                        oshirirb kelishgan
                                    </p>
                                </div>
                            </Box>
